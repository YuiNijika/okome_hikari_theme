        ...
        <div class="card bg-base-100 p-4 md:p-8 shadow-sm">
            <article class="prose max-w-none">
				...
				<a target="_blank" href="{url}" class="link-wrap block">
					<div class="card card-side bg-base-200 p-4 flex flex-row items-center gap-4 m-2 w-auto transition  duration-300 ease-in-out hover:scale-110 hover:bg-primary">
						<figure>
